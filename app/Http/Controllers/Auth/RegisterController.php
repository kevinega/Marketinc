...
class RegisterController extends Controller
{
    ...
    */
    public function confirm($confirmation_code){
        ...
        if($brand->save()){
            if($paid){
                return view('auth.login', ['message' => 'Thank you for confirming your email address, now you can use Marketinc as a free member. We\'ve sent an email concerning payment details for your paid membership']);    
            }
            
            return view('auth.login', ['message' => 'Thank you for confirming your email address, now you can use Marketinc as a free member']);
        }
    ...
    public function register(Request $request)
    {
        ...
        if($user){
            ...
            return view('auth.login',['message' => 'Thank you for registering, we\'ve sent you an email to verify your email address']);
        }
        // dd($user."luar");
    }
