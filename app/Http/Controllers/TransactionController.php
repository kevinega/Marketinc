    ...
    */
	function postConfirmation(Request $request) {
    	...
    	if($transaction == null || $transaction == "") {
    		return redirect('brand/confirmation')->with( 'message', "Transaction ID Invalid" );
    	}
    	...
    	if($transaction->save()) {
    		...
    		return redirect('brand/confirmation')->with('message', 'Confirmation is successfully submitted, please wait 2x24 hours our admin will process your payment confirmation and will send you an email to access your paid membership');
    	}
